...
3. **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize sow`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.sow` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.sow` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/prompts:arckit.sow` command | [PENDING] | [PENDING] |
```
...
- Major deliverables
- Suggested timeline
- Next steps (e.g., "Now run `/prompts:arckit.evaluate` to create vendor evaluation framework")

## Example Usage

User: `/prompts:arckit.sow Generate SOW for payment gateway modernization project`
...
- Run `/prompts:arckit.evaluate` to create vendor evaluation framework
```
...
- `/prompts:arckit.evaluate` -- Create vendor evaluation framework
- `/prompts:arckit.dos` -- Generate Digital Marketplace DOS opportunity
