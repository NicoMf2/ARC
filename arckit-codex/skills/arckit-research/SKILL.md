...
```text
**Generated by**: ArcKit `/prompts:arckit.research` agent
**Generated on**: {DATE}
...
- Next steps (run `/prompts:arckit.wardley`, `/prompts:arckit.sobc`, `/prompts:arckit.sow`)
...
- `/prompts:arckit.wardley` -- Create Wardley Map from research evolution positioning
- `/prompts:arckit.sobc` -- Feed TCO data into Economic Case
- `/prompts:arckit.sow` -- Create RFP from vendor requirements
- `/prompts:arckit.hld-review` -- Validate technology choices against HLD
