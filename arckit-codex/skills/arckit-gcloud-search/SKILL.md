...
- If NOT found: ERROR "Run /prompts:arckit.requirements first to define project needs"
...
- If NOT found: WARN "Consider running /prompts:arckit.principles to define cloud governance"
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.gcloud-search` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.gcloud-search` command
...
- **No requirements**: ERROR "Run /prompts:arckit.requirements first - need to define service needs"
- **Custom development detected**: ERROR "This is for custom development - use /prompts:arckit.dos instead"
...
✅ Use /prompts:arckit.dos instead - Digital Outcomes and Specialists
...
Only use /prompts:arckit.gcloud-search if you need:
