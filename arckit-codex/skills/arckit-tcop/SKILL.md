...
1. **Loading the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize tcop`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.tcop` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.tcop` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/prompts:arckit.tcop` command | [PENDING] | [PENDING] |
```
