...
3. **Read the templates** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize evaluate`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.evaluate` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.evaluate` command
...
User: `/prompts:arckit.evaluate Create evaluation framework for payment gateway project`
...
User: `/prompts:arckit.evaluate Score Acme Payment Solutions proposal for project 001`
...
User: `/prompts:arckit.evaluate Compare all vendors for payment gateway project`
