...
If the user specified a level (e.g., `/prompts:arckit.dfd level 1`), skip this question and proceed directly.
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.dfd` command | [PENDING] | [PENDING] |
```

**Populate Generation Metadata Footer**:

```markdown
**Generated by**: ArcKit `/prompts:arckit.dfd` command
...
Next Steps:
- /prompts:arckit.dfd level 1 — Decompose into sub-processes (if context diagram)
- /prompts:arckit.dfd level 2 — Detail a specific process (if Level 1 exists)
- /prompts:arckit.diagram — Generate C4 or deployment diagrams
- /prompts:arckit.data-model — Create formal data model from data stores
```
