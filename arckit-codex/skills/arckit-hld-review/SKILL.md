...
2. **Read Available Documents**:
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize hld-review`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.hld-review` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.hld-review` command
...
User: `/prompts:arckit.hld-review Review Acme Payment Solutions HLD for payment gateway project`
