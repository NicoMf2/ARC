...
> **Tip**: Users can customize templates with `/prompts:arckit.customize plan`
...
|------|----------|----------------|-------------|
| 1-2 | Stakeholder Analysis | `/prompts:arckit.stakeholders` | Stakeholder map, drivers, goals |
| 3-4 | User Research | Manual | User needs, pain points |
| 5-6 | Business Requirements | `/prompts:arckit.requirements` | BRs with acceptance criteria |
| 7 | Architecture Principles | `/prompts:arckit.principles` | 10-15 principles |
| 8 | Initial Business Case | `/prompts:arckit.business-case` | Cost/benefit analysis |
| 8 | Initial Risk Register | `/prompts:arckit.risk` | Top 10 risks |
...
### Discovery Phase
- Week 1-2: `/prompts:arckit.stakeholders` - Stakeholder analysis
- Week 5-6: `/prompts:arckit.requirements` - Business Requirements (BRs)
- Week 7: `/prompts:arckit.principles` - Architecture principles
- Week 8: `/prompts:arckit.business-case` - Initial business case
- Week 8: `/prompts:arckit.risk` - Initial risk register

### Alpha Phase
- Week 9-11: `/prompts:arckit.requirements` - Detailed requirements (FR, NFR, INT, DR)
- Week 12-15: `/prompts:arckit.diagram` - Architecture diagrams (C4)
- Week 11-12: `/prompts:arckit.sow` - Generate SOW/RFP (if vendor needed)
- Week 13-15: `/prompts:arckit.evaluate` - Vendor evaluation (if applicable)
- Week 18: `/prompts:arckit.hld-review` - HLD approval gate
- Week 19: `/prompts:arckit.business-case` - Updated business case

### Beta Phase
- Week 25: `/prompts:arckit.dld-review` - DLD approval gate
- Week 29-31: `/prompts:arckit.analyze` - Quality analysis
- Week 32-33: `/prompts:arckit.traceability` - Verify design → code → tests
- If AI: `/prompts:arckit.ai-playbook`, `/prompts:arckit.atrs` - AI compliance

### Live Phase
- Quarterly: `/prompts:arckit.analyze` - Periodic quality reviews
- Quarterly: `/prompts:arckit.risk` - Update operational risks
- Annually: `/prompts:arckit.business-case` - Track benefits realization
```
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.plan` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.plan` command
...
3. Start Discovery: Run `/prompts:arckit.stakeholders`
