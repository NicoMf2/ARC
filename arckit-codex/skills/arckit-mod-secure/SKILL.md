...
> **Tip**: Users can customize templates with `/prompts:arckit.customize mod-secure`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.mod-secure` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.mod-secure` command
