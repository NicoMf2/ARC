...
```text
**Generated by**: ArcKit `/prompts:arckit.aws-research` agent
**Generated on**: {DATE}
...
- `/prompts:arckit.diagram` -- Create AWS architecture diagrams
- `/prompts:arckit.devops` -- Design AWS CodePipeline CI/CD
- `/prompts:arckit.finops` -- Create AWS cost management strategy
- `/prompts:arckit.adr` -- Record AWS service selection decisions
