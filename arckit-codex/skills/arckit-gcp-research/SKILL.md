...
```text
**Generated by**: ArcKit `/prompts:arckit.gcp-research` agent
**Generated on**: {DATE}
...
- Next steps (`/prompts:arckit.diagram`, `/prompts:arckit.secure`, `/prompts:arckit.devops`)
...
- **No requirements found**: Stop, tell user to run `/prompts:arckit.requirements`
...
- `/prompts:arckit.diagram` -- Create Google Cloud architecture diagrams
- `/prompts:arckit.devops` -- Design Cloud Build pipeline
- `/prompts:arckit.finops` -- Create Google Cloud cost management strategy
- `/prompts:arckit.adr` -- Record Google Cloud service selection decisions
