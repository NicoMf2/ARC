...
> **Tip**: Users can customize templates with `/prompts:arckit.customize service-assessment`
...
- [ ] Re-run `/prompts:arckit.service-assessment` command weekly to track progress
...
**Weekly**:
- [ ] Re-run `/prompts:arckit.service-assessment PHASE=[phase]` to track progress
...
- `/prompts:arckit.analyze` - Comprehensive governance quality analysis
- `/prompts:arckit.traceability` - Requirements traceability matrix showing evidence chains

**Overlap with TCoP**:
- `/prompts:arckit.tcop` - Technology Code of Practice assessment (points 11, 13 overlap)

**Generate Missing Evidence**:
- `/prompts:arckit.requirements` - If user stories or NFRs weak
- `/prompts:arckit.hld-review` - If architecture decisions not documented
- `/prompts:arckit.secure` - If security assessment incomplete
- `/prompts:arckit.diagram` - If architecture diagrams missing
- `/prompts:arckit.wardley` - If technology strategy not clear
...
**Report Generated by**: ArcKit v{ARCKIT_VERSION} `/prompts:arckit.service-assessment` command

**Next Actions**:
1. Review this report with your team
2. Prioritize critical actions in your sprint planning
3. Re-run `/prompts:arckit.service-assessment PHASE=[phase]` weekly to track progress
...
```text
/prompts:arckit.service-assessment PHASE=alpha DATE=2025-12-15
```

Generates: `projects/001-nhs-appointment/ARC-001-SVCASS-v1.0.md`

```text
/prompts:arckit.service-assessment PHASE=beta
```
