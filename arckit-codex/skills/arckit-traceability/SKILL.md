...
2. **Artifacts pre-extracted by hook**:
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize traceability`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.traceability` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.traceability` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/prompts:arckit.traceability` command | [PENDING] | [PENDING] |
```

## Example Usage

User: `/prompts:arckit.traceability Generate traceability matrix for payment gateway project`
