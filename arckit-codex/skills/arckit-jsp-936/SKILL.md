...
> **Tip**: Users can customize templates with `/prompts:arckit.customize jsp-936`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.jsp-936` command |
```

### Generation Metadata Footer

```markdown
**Generated by**: ArcKit `/prompts:arckit.jsp-936` command
**Generated on**: {DATE}
