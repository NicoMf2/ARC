...
> **Tip**: Users can customize templates with `/prompts:arckit.customize maturity-model`
...
If no principles document exists, note this as a gap and recommend running `/prompts:arckit.principles` first for full alignment.
...
3. Create phased roadmap for maturity progression: `/prompts:arckit.roadmap`
4. Incorporate maturity targets into architecture strategy: `/prompts:arckit.strategy`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.maturity-model` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.maturity-model` command
...
7. **Integration with Other Commands**:
   - Maturity model is informed by: `/prompts:arckit.principles`, `/prompts:arckit.strategy`, `/prompts:arckit.requirements`, `/prompts:arckit.stakeholders`, `/prompts:arckit.risk`, `/prompts:arckit.data-model`
   - Maturity model feeds into: `/prompts:arckit.roadmap` (phased maturity progression), `/prompts:arckit.strategy` (capability targets), `/prompts:arckit.risk` (capability gap risks)
...
- `/prompts:arckit.roadmap` -- Create phased roadmap based on maturity progression
- `/prompts:arckit.strategy` -- Incorporate maturity targets into architecture strategy
