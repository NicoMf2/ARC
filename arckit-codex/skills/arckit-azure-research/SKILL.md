...
```text
**Generated by**: ArcKit `/prompts:arckit.azure-research` agent
**Generated on**: {DATE}
...
- `/prompts:arckit.diagram` -- Create Azure architecture diagrams
- `/prompts:arckit.devops` -- Design Azure DevOps pipeline
- `/prompts:arckit.finops` -- Create Azure cost management strategy
- `/prompts:arckit.adr` -- Record Azure service selection decisions
