...
3. **Read existing artifacts from the project context:**
   ...
   **Read the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize ai-playbook`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.ai-playbook` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.ai-playbook` command
...
User: `/prompts:arckit.ai-playbook Assess AI Playbook compliance for benefits eligibility chatbot using GPT-4`
