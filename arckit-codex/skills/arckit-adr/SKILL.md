...
- **If not found**: Read `.arckit/templates/adr-template.md` (default)
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize adr`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.adr` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.adr` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/prompts:arckit.adr` command | [PENDING] | [PENDING] |
```
...
- `/prompts:arckit.hld-review` -- Reflect decision in High-Level Design
- `/prompts:arckit.diagram` -- Update architecture diagrams
- `/prompts:arckit.traceability` -- Update traceability matrix with decision links
