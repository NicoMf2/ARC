...
1. **Loading the template** (with user override support):
   ...
   > **Tip**: Users can customize templates with `/prompts:arckit.customize secure`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.secure` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.secure` command
...
|---------|------|--------|---------|-------------|---------------|
| 1.0 | 2025-10-29 | ArcKit AI | Initial creation from `/prompts:arckit.secure` command | [PENDING] | [PENDING] |
```
