...
> **Tip**: Users can customize templates with `/prompts:arckit.customize glossary`
...
4. Review data model terminology: `/prompts:arckit.data-model`
...
```markdown
| 1.0 | {DATE} | ArcKit AI | Initial creation from `/prompts:arckit.glossary` command | [PENDING] | [PENDING] |
```
...
```markdown
**Generated by**: ArcKit `/prompts:arckit.glossary` command
...
7. **Integration with Other Commands**:
   - Glossary is informed by: `/prompts:arckit.requirements`, `/prompts:arckit.data-model`, `/prompts:arckit.stakeholders`, `/prompts:arckit.principles`, `/prompts:arckit.sobc`, `/prompts:arckit.research`, `/prompts:arckit.adr`, `/prompts:arckit.strategy`, `/prompts:arckit.risk`
   - Glossary feeds into: `/prompts:arckit.data-model` (validated entity/attribute names)
...
- `/prompts:arckit.data-model` -- Review data model for entity/attribute terminology
